...
""".strip()
    ...
    def contest_status(self, task_id: str, contester_argument: str) -> None:
        ...
        self.disputes[task_id] = json.dumps({
            "contester": contester,
    ...
    @gl.public.view
    def get_dispute(self, task_id: str) -> dict:
        assert task_id in self.disputes, "no dispute recorded"
        return json.loads(self.disputes[task_id])
